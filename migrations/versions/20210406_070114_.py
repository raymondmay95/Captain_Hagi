...
Revision ID: 508f69883f3f
Revises: 
Create Date: 2021-04-06 07:01:14.073813
...
def upgrade():
    ...
    sa.Column('aws_meta_data', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['aws_meta_data'], ['aws.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
